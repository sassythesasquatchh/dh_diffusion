...
class TrainLoop:
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        # TODO: Add a timer for the checkpoint to get intermediate results!
        self.last_checkpoint_time = time.time()
        self.checkpoint_time = 60 * 60 # Set a time: e.g. get checkpoint results every hour!
    ...
    def run_loop(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for motion, cond in tqdm(self.data):
                ...
                # Cond is an empty dictionary is there is no conditioning. Here we change is to the None type for ease of use in downstream functions
                if not cond:
                    cond = None
                else:
                ...
                # TODO: Implement a timer dependent checkpoint saver
                if time.time() - self.last_checkpoint_time >= self.checkpoint_time:
                    self.save()
                    self.model.eval()
                    self.evaluate()
                    self.model.train()
        ...
        # TODO: Comment this part for the time dependent checkpoint save approach
    ...
    def run_step(self, batch, cond):
        # TODO: Add verbose argument to allow printing the loss during the training loop
        self.forward_backward(batch, cond, verbose=False)
    ...
    def forward_backward(self, batch, cond, verbose=False):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            # TODO: Added the printing of the training loss
            if verbose:
                print('Loss: ', loss)
